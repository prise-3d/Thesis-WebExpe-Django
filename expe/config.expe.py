...
expe_name_list                 = ["quest_one_image", "quest_five_scenes"]
...
expes_configuration            = {
    ...
    'quest_five_scenes':{
        # do not forget to add slopes and new scenes is added for this experiment
        'scenes':['contemporary', 'bathroom', 'p3d_kitchen_800_800', 'pavilion_light', 'staircase-view0'], 
        ...
        'params':{
            ...
            'thresholds':{
                ...
                'bathroom' : [10, 2000, 20], #start, stop, step
                'p3d_kitchen_800_800' : [20,10000,40],
                'pavilion_light' : [20,10000,40],
                'staircase-view0' : [20,10000,40],
            },
            'slopes':{
                'contemporary' : [0.0001, 0.001, 0.00003], #start, stop, step
                'bathroom' : [0.0005, 0.01, 0.0003], #start, stop, step
                'p3d_kitchen_800_800' : [0.00001, 0.001, 0.00003], #start, stop, step
                'pavilion_light' : [0.00001, 0.001, 0.00003], #start, stop, step
                'staircase-view0' : [0.00001, 0.001, 0.00003], #start, stop, step
            },
        },
        ...
        'output_header': 
            "stimulus;name_stimulus;cropping_percentage;orientation;image_ref_position;answer;time_reaction;entropy;checkbox;iteration\n",
        'redirect' :
            "https://app.prolific.co/submissions/complete?cc=81609ABD"
    }
}
