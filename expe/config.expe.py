...
expes_configuration            = {
    ...
    'quest_one_image':{
        ...
        'text':{
            ...
            'question': "Do you see one image with the same quality everywhere or a composition of more than one image with different qualities?",
            ...
            'examples': {
                'sentence': ["Let's see some examples! \n Example 1 from 6 : ", 
                             ...
                             "Example 6 from 6: ",
                             "Even if it is more difficult to detect the difference the answer is a composition with different qualities! \n This image is cropped {0}. \n {1}% on the left originating from a low-quality image and on the right originating from a high quality image. \n So, press RIGHT.",
                             ],
                'crop_params': [
                    [0.3, 0, 0],
                    [0.3, 0, 0],
