...
def example_quest_five_scenes(request, expe_name, scene_name):
...
def run_quest_five_scenes(request, model_filepath, output_file):
...
def eval_quest_five_scenes(request, output_filename):
    expe_name = request.session.get('expe')
    lines = []
    with open(output_filename, 'r') as output_file:
        lines = output_file.readlines()
