...
expes_configuration            = {
    ...
    'quest_one_image':{
        ...
        'text':{
            ...
            'question': "Do you think that you are viewing a single image with the same quality everywhere, or instead a composition of two images with different qualities?\n \n Please be aware that we do not ask you to report the overall quality of the image. None of the images you will see are perfect, and this is part of the difficulty of this task.",
            'indication': "Press the LEFT key (&#8592;) if you think the image comes from a single one, or the RIGHT key (&#8594;) if you think the image is composed of two subparts with different qualities.",
            'end_text': "Experience is finished. Thanks for your participation!",
            'examples': {
                'sentence': ["Let's see some examples to illustrate the task! \n Example 1 from 6 : ", 
